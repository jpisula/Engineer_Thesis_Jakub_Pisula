...
export class EventComments extends React.Component {
    ...
    componentDidMount() {
        axios('http://192.168.0.32:80/api/requests/comments/getEventComments.php?id='+this.props.id, {
            method: "get",
    ...
    addComment() {
        ...
        axios('http://192.168.0.32:80/api/requests/comments/addEventComment.php', {
            method: "post",
            data: data,
            withCredentials: true,
            credentials: 'include',
